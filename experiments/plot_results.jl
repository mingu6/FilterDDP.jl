...
problemclass = "manip_pushing" # acrobot_contact, cartpole_friction, concar_quad, concar, manip_pushing
fs_x = 19
fs_y = 22
...
_, iters_fddp, status_fddp, objs_fddp, constrs_fddp, wall_fddp = read_results("filterddp/results/$problemclass.txt")
_, iters_ipo, status_ipo, objs_ipo, constrs_ipo, wall_ipo = read_results("ipopt/results/$problemclass.txt")
_, iters_ipob, status_ipob, objs_ipob, constrs_ipob, wall_ipob = read_results("ipopt/results/bfgs_$problemclass.txt")
_, iters_al, status_al, objs_al, constrs_al, _ = read_results("proxddp/results/$problemclass.txt")
...
savefig("plots/$(problemclass)_objective.png")
...
savefig("plots/$(problemclass)_violation.png")
...
savefig("plots/$(problemclass)_iteration.png")
...
savefig("plots/$(problemclass)_time_per.png")
...
savefig("plots/$(problemclass)_time.png")
...
plot(1:3000, [success_by_fddp success_by_ipo success_by_ipob success_by_al], legend=:right, fontfamily=font_,
    xtickfontsize=fs_y, ytickfontsize=fs_y, legendfontsize=fs_y, linewidth=2, size=(500, 600), ylims=(0, 101), label=names)
savefig("plots/$(problemclass)_succ_by_iter.png")
